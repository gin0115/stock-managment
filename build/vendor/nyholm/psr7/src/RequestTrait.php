...
trait RequestTrait
{
    ...
    public function getUri() : \PC_Woo_Stock_Man\Psr\Http\Message\UriInterface
    {
        return $this->uri;
    }
    public function withUri(\PC_Woo_Stock_Man\Psr\Http\Message\UriInterface $uri, $preserveHost = \false) : self
    {
        if ($uri === $this->uri) {
            return $this;
        }
