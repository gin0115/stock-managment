 ...
 */
class UploadedFile implements \PC_Woo_Stock_Man\Psr\Http\Message\UploadedFileInterface
{
    /** @var array */
    ...
    public function __construct($streamOrFile, $size, $errorStatus, $clientFilename = null, $clientMediaType = null)
    {
        ...
        if (\UPLOAD_ERR_OK === $this->error) {
            ...
            if (\is_string($streamOrFile) && '' !== $streamOrFile) {
                ...
                $this->stream = \PC_Woo_Stock_Man\Nyholm\Psr7\Stream::create($streamOrFile);
            } elseif ($streamOrFile instanceof \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface) {
    ...
    public function getStream() : \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface
    {
        $this->validateActive();
        if ($this->stream instanceof \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface) {
            return $this->stream;
        }
    ...
    public function moveTo($targetPath) : void
    {
        ...
        if (null !== $this->file) {
            ...
            $dest = \PC_Woo_Stock_Man\Nyholm\Psr7\Stream::create($resource);
            while (!$stream->eof()) {
