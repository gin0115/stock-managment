...
use PC_Woo_Stock_Man\Symfony\Component\Debug\ErrorHandler as SymfonyLegacyErrorHandler;
use PC_Woo_Stock_Man\Symfony\Component\ErrorHandler\ErrorHandler as SymfonyErrorHandler;
/**
 ...
 */
class Stream implements \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface
{
     ...
     */
    public static function create($body = '') : \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface
    {
        if ($body instanceof \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface) {
            return $body;
        }
        if (\is_string($body)) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($e instanceof \Error || $errorHandler instanceof \PC_Woo_Stock_Man\Symfony\Component\ErrorHandler\ErrorHandler || $errorHandler instanceof \PC_Woo_Stock_Man\Symfony\Component\Debug\ErrorHandler) {
