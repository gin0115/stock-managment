...
trait MessageTrait
{
    ...
    public function getBody() : \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface
    {
        if (null === $this->stream) {
            $this->stream = \PC_Woo_Stock_Man\Nyholm\Psr7\Stream::create('');
        }
        return $this->stream;
    }
    public function withBody(\PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface $body) : self
    {
        if ($body === $this->stream) {
            return $this;
        }
