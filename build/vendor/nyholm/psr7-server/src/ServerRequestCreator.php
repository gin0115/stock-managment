...
namespace PC_Woo_Stock_Man\Nyholm\Psr7Server;
 ...
 */
final class ServerRequestCreator implements \PC_Woo_Stock_Man\Nyholm\Psr7Server\ServerRequestCreatorInterface
{
    private $serverRequestFactory;
    private $uriFactory;
    private $uploadedFileFactory;
    private $streamFactory;
    public function __construct(\PC_Woo_Stock_Man\Psr\Http\Message\ServerRequestFactoryInterface $serverRequestFactory, \PC_Woo_Stock_Man\Psr\Http\Message\UriFactoryInterface $uriFactory, \PC_Woo_Stock_Man\Psr\Http\Message\UploadedFileFactoryInterface $uploadedFileFactory, \PC_Woo_Stock_Man\Psr\Http\Message\StreamFactoryInterface $streamFactory)
    {
     ...
     * {@inheritdoc}
     */
    public function fromGlobals() : \PC_Woo_Stock_Man\Psr\Http\Message\ServerRequestInterface
    {
        $server = $_SERVER;
     ...
     * {@inheritdoc}
     */
    public function fromArrays(array $server, array $headers = [], array $cookie = [], array $get = [], ?array $post = null, array $files = [], $body = null) : \PC_Woo_Stock_Man\Psr\Http\Message\ServerRequestInterface
    {
        ...
        } elseif (!$body instanceof \PC_Woo_Stock_Man\Psr\Http\Message\StreamInterface) {
    ...
    private function getUriFromEnvWithHTTP(array $environment) : \PC_Woo_Stock_Man\Psr\Http\Message\UriInterface
    {
    ...
    private function normalizeFiles(array $files) : array
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \PC_Woo_Stock_Man\Psr\Http\Message\UploadedFileInterface) {
     ...
     */
    private function createUriFromArray(array $server) : \PC_Woo_Stock_Man\Psr\Http\Message\UriInterface
    {
