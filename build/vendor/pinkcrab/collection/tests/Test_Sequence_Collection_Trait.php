...
use pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Sequence_Collection;
class Test_Sequence_Collection_Trait extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $collection = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Sequence_Collection(array(1, 2, 3, 4, 5));
        $collection->reverse();
    ...
    public function test_throws_if_getting_first_of_empty_collection() : void
    {
        ...
        $collection = \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Sequence_Collection::from(array());
        $collection->first();
    }
    /**
    ...
    {
        $collection = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Sequence_Collection(array(1, 'tree', '2', 5, 9.9));
