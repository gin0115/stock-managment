...
use pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Indexed_Collection;
class Test_Indexed_Collection_Trait extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $collection = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Indexed_Collection(array('a' => 1, 'b' => 2));
    ...
    {
        $collection = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Indexed_Collection(array('a' => 1, 'b' => 2, 'c' => 1, 'd' => 1));
        ...
        $collection_objects = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Indexed_Collection(array('a' => $obj_a, 'b' => $obj_b, 'c' => $obj_a));
    ...
    {
        $collection = new \pc_stock_man_v1\PinkCrab\Collection\Tests\Fixtures\Indexed_Collection(array('a' => 1, 'b' => 2, 'c' => 3, 'd' => 4));
