...
use PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output;
use PC_Woo_Stock_Man\Symfony\Component\DomCrawler\Crawler;
use PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Arrays as Arr;
use PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Comparisons as Comp;
use PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions as Func;
class Test_Enqueue_Functional extends \WP_UnitTestCase
{
    ...
    public function test_is_add_to_enqueue_stack() : void
    {
        ...
        $script = \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::script('script_handle')->src('https://url.com/Fixtures/script_file.js')->deps('jquery', 'angularjs')->ver('1.2.3')->localize(array('key_int' => 1, 'key_array' => array('string', 'val')))->footer()->register();
    ...
    public function test_add_script_attributes() : void
    {
        ...
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::script('script_with_atts')->src('https://url.com/Fixtures/script_file_with_atts.js')->ver('1.2.3')->footer(\false)->flag('script_flag')->attribute('ATT', 'ribute')->register();
        });
        // Run and get all scripts/styles for header
        $header_html = \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () {
            do_action('init');
            do_action('wp_enqueue_scripts');
            do_action('wp_head');
        });
        $crawler = new \PC_Woo_Stock_Man\Symfony\Component\DomCrawler\Crawler($header_html);
        // Script tags
        $script = \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Arrays\filterFirst(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Comparisons\all(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\hasProperty('src'), \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\propertyEquals('src', 'https://url.com/Fixtures/script_file_with_atts.js?ver=1.2.3')))($this->get_all_script_tags($header_html));
    ...
    {
        $crawler = new \PC_Woo_Stock_Man\Symfony\Component\DomCrawler\Crawler($html);
        $scripts = array();
    ...
    public function test_add_style_attributes() : void
    {
        // Enqueue
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::style('style_with_atts')->src('https://url.com/Fixtures/script_file.css')->ver('1.2.3')->flag('style_flag')->attribute('att', 'ribute')->register();
        });
    ...
    public function test_only_registers_script_for_block() : void
    {
        // Enqueue
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::script('script_for_block')->src('https://url.com/Fixtures/for_block.js')->header()->for_block()->register();
        });
        // Run and get all styles for header
        $header_html = \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () {
            do_action('init');
        ...
        $script = \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Arrays\filterFirst(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Comparisons\all(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\hasProperty('id'), \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\propertyEquals('id', 'script_for_block-js')))($this->get_all_script_tags($header_html));
    ...
    public function test_enqueues_script_for_none_block() : void
    {
        // Enqueue
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::script('script_not_for_block')->src('https://url.com/Fixtures/not_for_block.js')->header()->register();
        });
        // Run and get all styles for header
        $header_html = \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () {
            do_action('init');
        ...
        // Attempt to find script in header, should not exist.
        $script = \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Arrays\filterFirst(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\Comparisons\all(\PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\hasProperty('id'), \PC_Woo_Stock_Man\PinkCrab\FunctionConstructors\GeneralFunctions\propertyEquals('id', 'script_not_for_block-js')))($this->get_all_script_tags($header_html));
    ...
    public function test_only_registers_style_for_block() : void
    {
        // Enqueue
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::style('style_for_block')->src('https://url.com/Fixtures/for_block.css')->header()->for_block()->register();
        });
        \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () {
            do_action('init');
            do_action('wp_enqueue_scripts');
            do_action('wp_head');
        });
    ...
    public function test_enqueues_style_for_none_block() : void
    {
        // Enqueue
        add_action('wp_enqueue_scripts', function () {
            \PC_Woo_Stock_Man\PinkCrab\Enqueue\Enqueue::style('style_not_for_block')->src('https://url.com/Fixtures/not_for_block.js')->header()->register();
        });
        \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () {
            do_action('init');
            do_action('wp_enqueue_scripts');
