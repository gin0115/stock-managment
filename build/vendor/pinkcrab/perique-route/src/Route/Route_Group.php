 ...
 * @since 0.0.1
 */
namespace pc_stock_man_v1\PinkCrab\Route\Route;
...
class Route_Group extends \pc_stock_man_v1\PinkCrab\Route\Route\Abstract_Route
{
    /**
     * @var Route[]
     */
    ...
    public function __construct(string $namespace, string $route)
    {
        ...
        $this->route_factory = new \pc_stock_man_v1\PinkCrab\Route\Route_Factory($namespace);
    }
    /**
     ...
     * @return Route
     */
    public function get(callable $callable) : \pc_stock_man_v1\PinkCrab\Route\Route\Route
    {
        $route = $this->route_factory->get($this->route, $callable);
        $route->namespace($this->namespace);
        $this->routes[\pc_stock_man_v1\PinkCrab\Route\Route\Route::GET] = $route;
        return $route;
    }
    /**
     ...
     * @return Route
     */
    public function post(callable $callable) : \pc_stock_man_v1\PinkCrab\Route\Route\Route
    {
        $route = $this->route_factory->post($this->route, $callable);
        $route->namespace($this->namespace);
        $this->routes[\pc_stock_man_v1\PinkCrab\Route\Route\Route::POST] = $route;
        return $route;
    }
    /**
     ...
     * @return Route
     */
    public function put(callable $callable) : \pc_stock_man_v1\PinkCrab\Route\Route\Route
    {
        $route = $this->route_factory->put($this->route, $callable);
        $route->namespace($this->namespace);
        $this->routes[\pc_stock_man_v1\PinkCrab\Route\Route\Route::PUT] = $route;
        return $route;
    }
    /**
     ...
     * @return Route
     */
    public function patch(callable $callable) : \pc_stock_man_v1\PinkCrab\Route\Route\Route
    {
        $route = $this->route_factory->patch($this->route, $callable);
        $route->namespace($this->namespace);
        $this->routes[\pc_stock_man_v1\PinkCrab\Route\Route\Route::PATCH] = $route;
        return $route;
    }
    /**
     ...
     * @return Route
     */
    public function delete(callable $callable) : \pc_stock_man_v1\PinkCrab\Route\Route\Route
    {
        $route = $this->route_factory->delete($this->route, $callable);
        $route->namespace($this->namespace);
        $this->routes[\pc_stock_man_v1\PinkCrab\Route\Route\Route::DELETE] = $route;
        return $route;
    }
    /**
     ...
     * @return self
     */
    public function add_rest_route(\pc_stock_man_v1\PinkCrab\Route\Route\Route $route) : self
    {
