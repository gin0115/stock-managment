...
class Test_Meta_Box_Validator extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $validator = new \pc_stock_man_v1\PinkCrab\Registerables\Validator\Meta_Box_Validator();
        $this->assertFalse($validator->validate($this->createMock(\pc_stock_man_v1\PinkCrab\Registerables\Registration_Middleware\Registerable::class)));
    }
    ...
    {
        $validator = new \pc_stock_man_v1\PinkCrab\Registerables\Validator\Meta_Box_Validator();
        $result = $validator->verify_meta_box(new \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Basic_Hierarchical_Taxonomy());
        $this->assertFalse($result);
        $this->assertTrue($validator->has_errors());
        $this->assertContains(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Basic_Hierarchical_Taxonomy::class . ' is not a valid Meta Box Model', $validator->get_errors());
    }
    ...
    {
        $validator = new \pc_stock_man_v1\PinkCrab\Registerables\Validator\Meta_Box_Validator();
        $result = $validator->verify_meta_box(new \pc_stock_man_v1\PinkCrab\Registerables\Meta_Box('no label'));
        $this->assertFalse($result);
        $this->assertTrue($validator->has_errors());
        $this->assertContains('label is not set on ' . \pc_stock_man_v1\PinkCrab\Registerables\Meta_Box::class . ' Meta Box Model', $validator->get_errors());
    }
    ...
    {
        $validator = new \pc_stock_man_v1\PinkCrab\Registerables\Validator\Meta_Box_Validator();
        $meta_box = new \pc_stock_man_v1\PinkCrab\Registerables\Meta_Box('fails');
        $meta_box->label = 'FAILS';
        // Fails if not a callable and no template.
        $result = $validator->verify_meta_box($meta_box);
        $this->assertFalse($result);
        $this->assertTrue($validator->has_errors());
        $this->assertContains(\pc_stock_man_v1\PinkCrab\Registerables\Meta_Box::class . ' doesn\'t have a valid view defined.', $validator->get_errors());
    ...
    {
        $validator = new \pc_stock_man_v1\PinkCrab\Registerables\Validator\Meta_Box_Validator();
        $meta_box = new \pc_stock_man_v1\PinkCrab\Registerables\Meta_Box('passes');
        $meta_box->label = 'PASS';
        // With a callable
