...
class Test_Meta_Data_Registrar extends \WP_UnitTestCase
{
    ...
    public function test_skip_if_no_subtype_defined() : void
    {
        ...
        $meta = (new \pc_stock_man_v1\PinkCrab\Registerables\Meta_Data('meta_key'))->meta_type('post')->rest_schema(array('type' => 'number', 'description' => 'test 2', 'default' => 3.245));
    ...
    public function test_throw_exception_if_error_registering_meta_data() : void
    {
        ...
        $meta = (new \pc_stock_man_v1\PinkCrab\Registerables\Meta_Data('meta_key'))->post_type('page')->type('array')->rest_schema(array('type' => 'array'));
        $registrar = new \pc_stock_man_v1\PinkCrab\Registerables\Registrar\Meta_Data_Registrar();
