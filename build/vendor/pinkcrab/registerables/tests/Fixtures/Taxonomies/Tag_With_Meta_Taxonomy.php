...
class Tag_With_Meta_Taxonomy extends \PC_Woo_Stock_Man\PinkCrab\Registerables\Taxonomy
{
    ...
    {
        return \PC_Woo_Stock_Man\PinkCrab\WP_Rest_Schema\Argument\Number_Type::on(self::META_2['key'])->description('test 2')->default(3.14);
    }
    // Returns as an array for comparison.
    public static function meta_rest_key_2_schema_as_array() : array
    {
        return array('type' => 'number', 'description' => 'test 2', 'default' => 3.14);
    }
    ...
    // Default term
    public $default_term = array('name' => 'Default Term for Taxonomy With Meta', 'slug' => self::DEFAULT_TERM_SLUG, 'description' => 'Like the name');
    /**
