...
class Test_Basic_Hierarchical_Taxonomy extends \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Application\Taxonomies\Base_Taxonomy_Runner
{
    protected $taxonomy_class = \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Basic_Hierarchical_Taxonomy::class;
    protected $post_types = array('basic_cpt', 'page');
    protected $settings = array('name' => 'basic_hier_tax', 'label' => 'Basic Hier Taxonomies', 'description' => 'The Basic Hier Taxonomy.', 'publicly_queryable' => \true, 'show_ui' => \false, 'show_in_menu' => \false, 'show_in_nav_menus' => \false, 'show_tagcloud' => \false, 'show_in_quick_edit' => \false, 'show_admin_column' => \false, 'rewrite' => 'basic_hier_tax', 'query_var' => \false, 'update_count_callback' => '_update_post_term_count', 'show_in_rest' => \false, 'rest_base' => 'basic_hier_tax', 'rest_controller_class' => 'WP_REST_Terms_Controller', 'default_term' => null);
