...
use pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy;
class Test_Taxonomy_With_Term_Meta extends \WP_UnitTestCase
{
    ...
    {
        $this->taxonomy = new \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy();
        self::create_with_registerables(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::class)->boot();
        do_action('init');
        // Build inspector.
    ...
    public function test_default_term() : void
    {
        $this->assertNotEmpty(\array_filter($this->get_terms(), function (\WP_Term $term) : bool {
            return $term->slug === \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::DEFAULT_TERM_SLUG;
        }));
    }
    ...
    public function test_can_set_term_meta() : void
    {
        ...
        $meta1 = get_term_meta($term_id, \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_1['key'], \true);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_1['default'], $meta1);
        $meta2 = get_term_meta($term_id, \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_2['key'], \true);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_2['default'], $meta2);
    }
    ...
    public function test_meta_data_registered_taxonomy() : void
    {
        ...
        // Meta 1 Values.
        $meta1 = $this->meta_data_inspector->find_term_meta($this->taxonomy->slug, \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_1['key']);
        $this->assertInstanceOf(\pc_stock_man_v1\Gin0115\WPUnit_Helpers\WP\Entities\Meta_Data_Entity::class, $meta1);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::meta_rest_key_1_schema(), $meta1->show_in_rest);
        // Meta 2 Values.
        $meta2 = $this->meta_data_inspector->find_term_meta($this->taxonomy->slug, \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::META_2['key']);
        $this->assertInstanceOf(\pc_stock_man_v1\Gin0115\WPUnit_Helpers\WP\Entities\Meta_Data_Entity::class, $meta2);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Tag_With_Meta_Taxonomy::meta_rest_key_2_schema_as_array(), $meta2->show_in_rest);
    }
}
