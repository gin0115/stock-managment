...
use PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT;
class Test_Meta_Data_Rest_CPT extends \WP_UnitTestCase
{
    ...
    public function setUp() : void
    {
        ...
        $this->cpt = new \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT();
        self::create_with_registerables(\PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::class)->boot();
        do_action('init');
        // Build inspector.
    ...
    public function test_meta_data_registered() : void
    {
        ...
        // Meta 1 Values.
        $meta1 = $this->meta_data_inspector->find_post_meta($this->cpt->key, \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::META_1['key']);
        $this->assertInstanceOf(\PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\WP\Entities\Meta_Data_Entity::class, $meta1);
        $this->assertEquals(\PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::meta_rest_key_1_schema(), $meta1->show_in_rest);
        // Meta 2 Values.
        $meta2 = $this->meta_data_inspector->find_post_meta($this->cpt->key, \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::META_2['key']);
        $this->assertInstanceOf(\PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\WP\Entities\Meta_Data_Entity::class, $meta2);
        $this->assertEquals(\PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::meta_rest_key_2_schema_as_array(), $meta2->show_in_rest);
        // Test that rest field were registered.
        $rest_fields = $GLOBALS['wp_rest_additional_fields'];
        $field_1 = \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::META_1['key'];
        $field_2 = \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\Meta_Data_Rest_CPT::META_2['key'];
