...
use PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT;
class Test_MetaBox_CPT extends \WP_UnitTestCase
{
    ...
    public function setUp() : void
    {
        ...
        if (!$this->cpt) {
            ...
            $this->cpt = new \PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT();
            self::create_with_registerables(\PC_Woo_Stock_Man\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT::class)->boot();
            do_action('init');
    ...
    public function test_normal_metabox_registered() : void
    {
        ...
        $view_output = \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () use($box) {
    ...
    public function test_side_metabox_registered() : void
    {
        ...
        $view_output = \PC_Woo_Stock_Man\Gin0115\WPUnit_Helpers\Output::buffer(function () use($box, $post) {
            $this->meta_box_inspector->set_meta_boxes()->render_meta_box($box, \get_post($post));
        });
