...
use pc_stock_man_v1\Gin0115\WPUnit_Helpers\Output;
...
use pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT;
class Test_MetaBox_CPT extends \WP_UnitTestCase
{
    ...
    public function setUp() : void
    {
        ...
        if (!$this->cpt) {
            ...
            $this->cpt = new \pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT();
            self::create_with_registerables(\pc_stock_man_v1\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT::class)->boot();
            do_action('init');
    ...
    public function test_normal_metabox_registered() : void
    {
        ...
        $view_output = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Output::buffer(function () use($box) {
    ...
    public function test_side_metabox_registered() : void
    {
        ...
        $view_output = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Output::buffer(function () use($box, $post) {
