...
class Base_CPT_Case extends \WP_UnitTestCase
{
    ...
    public function test_use_gutenberg() : void
    {
        ...
        $this->assertEquals($expected, use_block_editor_for_post_type($this->cpt->key), \sprintf('Failed asserting that CPT %s has correct gutenberg usage settings. Expected %s for %s', $this->cpt->key, $expected ? 'TRUE' : 'FALSE', $this->cpt->key));
    }
}
