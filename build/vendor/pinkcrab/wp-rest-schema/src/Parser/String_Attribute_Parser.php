...
class String_Attribute_Parser extends \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\Abstract_Parser
{
    /**
    ...
    public function parse_attributes() : array
    {
        ...
        if (!\is_a($this->argument, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\String_Type::class)) {
            return array();
        }
