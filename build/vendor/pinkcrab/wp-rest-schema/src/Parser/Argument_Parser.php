...
use pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\Array_Attribute_Parser;
use pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\Object_Attribute_Parser;
class Argument_Parser
{
     ...
     */
    public static function as_array(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument $argument) : array
    {
     ...
     * @return mixed[]
     */
    public static function as_list(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument $argument) : array
    {
     ...
     * @return mixed[]
     */
    public static function as_single(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument $argument) : array
    {
        $parsed = (new self($argument))->parse_as_indexed_array();
        return \count($parsed) < 1 ? array() : \reset($parsed);
    }
    /**
     ...
     * @return mixed[]
     */
    public static function for_meta_data(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument $argument) : array
    {
    ...
    {
        return array($this->argument->get_key() => \array_merge($this->shared_attributes(), $this->get_type_attributes()));
    }
    /**
    ...
    {
        return \array_merge($this->shared_attributes(), $this->get_type_attributes());
    }
    /**
    ...
    protected function get_type_attributes() : array
    {
        switch ($this->argument->get_type()) {
            case \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_STRING:
                return \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\String_Attribute_Parser::parse($this->argument);
            case \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NUMBER:
            case \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER:
                return $this->numeric_attributes();
            case \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY:
                return \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\Array_Attribute_Parser::parse($this->argument);
            case \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT:
                return \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Parser\Object_Attribute_Parser::parse($this->argument);
            default:
                return array();
        }
    }
    ...
    public function numeric_attributes() : array
    {
        ...
        if (!\is_a($this->argument, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Number_Type::class) && !\is_a($this->argument, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Integer_Type::class)) {
            return array();
        }
    ...
    public function object_attributes() : array
    {
        ...
        if (!empty($properties)) {
            ...
            $attributes['properties'] = 'allOf' === $relationship ? $properties : array($relationship => $properties);
        }
        return $attributes;
    }
    /**
     ...
     * @return array<string, mixed>
     */
    public function parse_object_properties(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Object_Type $argument, string $property_type = 'regular') : array
    {
        ...
        return \array_map(function ($property) : array {
