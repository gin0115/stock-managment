...
use pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Attribute\Children;
use pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Attribute\Element_Requirements;
class Object_Type extends \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument
{
    ...
    public function __construct(string $key)
    {
        ...
        $this->type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_STRING, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NUMBER, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NULL, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_BOOLEAN, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY, $config);
    }
    /**
    ...
    {
        return $this->add_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_STRING, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NUMBER, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NULL, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_BOOLEAN, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY, $config);
    }
    /**
    ...
    {
        return $this->add_additional_property($name, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_STRING, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NUMBER, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NULL, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_BOOLEAN, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY, $config);
    }
    /**
    ...
    {
        return $this->add_pattern_property($pattern, \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT, $config);
    }
    /**
