...
class Array_Type extends \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument
{
    use Element_Requirements, Children;
    public function __construct(string $key)
    {
        parent::__construct($key);
        $this->type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY);
    }
    /**
     * Adds a single item
     *
     ...
     * @return self
     */
    public function item(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument $item) : self
    {
    ...
    protected function create_item_type(string $type, ?callable $config = null) : self
    {
        ...
        return $this->item(\is_null($config) ? $item : $config($item));
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_STRING, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NUMBER, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_BOOLEAN, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_ARRAY, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_NULL, $config);
    }
    /**
    ...
    {
        return $this->create_item_type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_OBJECT, $config);
    }
    /**
     * Get the item schema
     *
     ...
     * @return self
     */
    public function unique_items(bool $unique = \true) : self
    {
