...
use pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Attribute\Number_Attributes;
class Integer_Type extends \pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument
{
    /**
    ...
    public function __construct(string $key)
    {
        ...
        $this->type(\pc_stock_man_v1\PinkCrab\WP_Rest_Schema\Argument\Argument::TYPE_INTEGER);
    }
    /**
    ...
    {
        return \array_key_exists('minimum', $this->attributes) ? $this->attributes['minimum'] : null;
    }
    /**
    ...
    {
        return \array_key_exists('maximum', $this->attributes) ? $this->attributes['maximum'] : null;
    }
}
