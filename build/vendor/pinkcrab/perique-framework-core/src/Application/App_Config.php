...
final class App_Config
{
     ...
     */
    protected $meta = array(self::POST_META => array(), self::USER_META => array(), self::TERM_META => array());
    /**
    ...
    public function path(?string $path = null, ?string $default = null)
    {
        ...
        return \array_key_exists($path, $this->paths['path']) ? trailingslashit($this->paths['path'][$path]) : $default;
    }
    /**
     * Gets a path with trailing slash.
     *
    ...
    public function url(?string $url = null, ?string $default = null)
    {
        ...
        return \array_key_exists($url, $this->paths['url']) ? trailingslashit($this->paths['url'][$url]) : $default;
    }
    /**
    ...
    {
        return \array_key_exists($key, $this->namespaces) ? $this->namespaces[$key] : $default;
    }
    /**
    ...
    {
        return \array_key_exists($key, $this->additional) ? $this->additional[$key] : $default;
    }
    /**
    ...
    public function set_meta(array $meta) : void
    {
        ...
        foreach ($meta as $meta_type => $pairs) {
            if (!\in_array($meta_type, $valid_meta_types, \true)) {
