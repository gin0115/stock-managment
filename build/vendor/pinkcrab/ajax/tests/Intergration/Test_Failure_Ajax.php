...
class Test_Failure_Ajax extends \PC_Woo_Stock_Man\PinkCrab\Ajax\Tests\Fixtures\Ajax_BaseCase
{
    /**
    ...
    public function test_missing_action_ajax_model() : void
    {
        ...
        $this->assertStringContainsString(\PC_Woo_Stock_Man\PinkCrab\Ajax\Tests\Fixtures\Ajax\Failure_Ajax::class, $response->error);
