...
class Test_Hook extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $hook = new \pc_stock_man_v1\PinkCrab\Loader\Hook('my_action', 'is_int', 999, 2);
        ...
        // Check defaults.
        $hook_default = new \pc_stock_man_v1\PinkCrab\Loader\Hook('my_filter', 'is_string');
    ...
    public function test_can_set_type() : void
    {
        ...
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION, $hook->get_type());
        $hook_filter = $hook->type(\pc_stock_man_v1\PinkCrab\Loader\Hook::FILTER);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::FILTER, $hook_filter->get_type());
        $hook_ajax = $hook_filter->type(\pc_stock_man_v1\PinkCrab\Loader\Hook::AJAX);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::AJAX, $hook_ajax->get_type());
        $hook_shortcode = $hook_ajax->type(\pc_stock_man_v1\PinkCrab\Loader\Hook::SHORTCODE);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::SHORTCODE, $hook_shortcode->get_type());
        $hook_action = $hook_shortcode->type(\pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION, $hook_action->get_type());
        $hook_remove = $hook_action->type(\pc_stock_man_v1\PinkCrab\Loader\Hook::REMOVE);
        $this->assertEquals(\pc_stock_man_v1\PinkCrab\Loader\Hook::REMOVE, $hook_remove->get_type());
    }
    /** @testdox Can modify and get the hooks handle */
    public function test_handle_methods() : void
    {
        $hook = new \pc_stock_man_v1\PinkCrab\Loader\Hook('empty', 'is_string');
        $hook->handle('test');
    ...
    {
        $hook = new \pc_stock_man_v1\PinkCrab\Loader\Hook('foo', 'is_bool');
    ...
    {
        $hook = new \pc_stock_man_v1\PinkCrab\Loader\Hook('foo', 'is_bool', 42);
        $hook->priority(420);
    ...
    {
        $hook = new \pc_stock_man_v1\PinkCrab\Loader\Hook('foo', 'is_bool', 42, 1);
        $hook->args(2);
        $this->assertEquals(2, $hook->args_count());
    }
