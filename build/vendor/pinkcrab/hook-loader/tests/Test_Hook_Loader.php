...
use pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays as Arr;
use pc_stock_man_v1\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_NoOp_Mock;
...
class Test_Hook_Loader extends \WP_UnitTestCase
{
    ...
    public function test_can_be_contrustucted_with_internal_resources() : void
    {
        ...
        $this->assertInstanceOf(\pc_stock_man_v1\PinkCrab\Loader\Hook_Collection::class, \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks'));
        $this->assertInstanceOf(\pc_stock_man_v1\PinkCrab\Loader\Hook_Factory::class, \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hook_factory'));
    }
    ...
    public function test_add_actions() : void
    {
        ...
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION && $e->get_handle() === 'global_action';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION && $e->get_handle() === 'admin_action';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::ACTION && $e->get_handle() === 'front_action';
        })($hooks->export()));
    }
    ...
    public function test_add_filters() : void
    {
        ...
        $hooks = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks');
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::FILTER && $e->get_handle() === 'global_filter';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::FILTER && $e->get_handle() === 'admin_filter';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::FILTER && $e->get_handle() === 'front_filter';
        })($hooks->export()));
    }
    ...
    public function test_remove_hook() : void
    {
        ...
        $hooks = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks');
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::REMOVE && $e->get_handle() === 'hookk';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::REMOVE && $e->get_handle() === 'filter_hook';
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::REMOVE && $e->get_handle() === 'action_hook';
        })($hooks->export()));
    }
    ...
    public function test_ajax() : void
    {
        ...
        $hooks = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks');
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::AJAX && $e->get_handle() === 'either' && $e->is_ajax_public() === \true && $e->is_ajax_private() === \true;
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::AJAX && $e->get_handle() === 'only_public' && $e->is_ajax_public() === \true && $e->is_ajax_private() === \false;
        })($hooks->export()));
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::AJAX && $e->get_handle() === 'only_private' && $e->is_ajax_public() === \false && $e->is_ajax_private() === \true;
        })($hooks->export()));
    }
    ...
    public function test_shortcode() : void
    {
        ...
        $hooks = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks');
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
            return $e->get_type() === \pc_stock_man_v1\PinkCrab\Loader\Hook::SHORTCODE && $e->get_handle() === 'my_shortcode';
        })($hooks->export()));
    }
    ...
    public function test_register_hooks() : void
    {
        ...
        $loader->register_hooks(new \pc_stock_man_v1\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_NoOp_Mock());
        /** @var Hook_Collection Extracted internal Collection */
        $hooks = \pc_stock_man_v1\Gin0115\WPUnit_Helpers\Objects::get_property($loader, 'hooks');
        $this->assertEquals(1, \pc_stock_man_v1\PinkCrab\FunctionConstructors\Arrays\filterCount(function ($e) {
