 ...
 */
namespace PC_Woo_Stock_Man\PinkCrab\Loader\Tests\Intergration;
...
class Test_Hook_Manager_Intergration extends \WP_UnitTestCase
{
    ...
    {
        // Hooks
        $global = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('global', 'is_string');
        $admin = (new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('admin', 'is_string'))->front(\false);
        // Front & Admin true by default.
        $front = (new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('front', 'is_string'))->admin(\false);
        // Front
        $manager_front = new \PC_Woo_Stock_Man\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
        ...
        $manager_admin = new \PC_Woo_Stock_Man\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
    ...
    {
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_action', 'is_string');
        $manager = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\PC_Woo_Stock_Man\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_action', 'no_Callback_HERE');
        $manager = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_filter', 'is_string');
    ...
    {
        $this->expectException(\PC_Woo_Stock_Man\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_filter', 'no_Callback_HERE');
        $hook->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::FILTER);
        $manager = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    public function test_can_remove_hook() : void
    {
        ...
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('remove_me_action', 'is_string');
    ...
    {
        $this->expectException(\PC_Woo_Stock_Man\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('remove_me_action', 'no_Callback_HERE');
        $hook->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::REMOVE);
        $manager = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook_both = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_ajax_both', 'is_string');
        $hook_both->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_ajax_public', 'is_string');
        $hook_public_only->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only->ajax_private(\false);
        $hook_private_only = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_ajax_private', 'is_string');
        $hook_private_only->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::AJAX);
        $hook_private_only->ajax_public(\false);
        $hook_neither = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_ajax_neither', 'is_string');
        $hook_neither->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::AJAX);
    ...
    {
        $shortcode = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_shortcode', 'is_string');
        $shortcode->type(\PC_Woo_Stock_Man\PinkCrab\Loader\Hook::SHORTCODE);
        $manager = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\PC_Woo_Stock_Man\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Woo_Stock_Man\PinkCrab\Loader\Hook('my_shortcode', 'no_Callback_HERE');
